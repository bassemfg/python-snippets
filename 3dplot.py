# -*- coding: utf-8 -*-
"""
Created on Mon Oct 22 10:55:17 2018
...
def z_func(a, b):
    return (2+(a) * (a) -2*a -2*b + (b ) * (b))

x1 = np.arange(-15.0, 15, 0.1) # x1 >= 0 according to given conditions
x2 = np.arange(-15.0, 15, 0.1) # x2 <= 1 according to given conditions
